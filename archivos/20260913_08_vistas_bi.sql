-- ============================================================================
-- 08 — Vistas para análisis y BI
-- Requiere: 01 a 07
--
-- Todas son "create or replace": el archivo se puede reejecutar sin problema.
-- Conéctalas desde Power BI en vez de las tablas.
-- ============================================================================
...
-- ==================== COTIZACIONES PARA POWER BI ============================
-- Tabla ancha con todo resuelto: ya no hay que hacer joins en el reporte.
...
select
  ...
  -- Cuántos productos y si terminó en venta
...
select
  ...
  v.id_cotizacion,
  v.fecha_venta,
  v.fecha_venta::date        as fecha_dia,
  ...
  fl.flg_primera_venta,
  fl.flg_recompra,

  -- Cuánto tardó desde que se cotizó hasta que compró
